...
void timingGameHandler(LowerBox *lower, int speed) {
	...
	if (speed < 3) {
	    char *new = "----------------------------------------------------------------------------------------------------\n"
					"|                                                                                                  |\n"
					"|                                                                                                  |\n"
					"|     Oh no, a zombie appeared! Get ready to attack! Time your attacks well!                       |\n"
					"|                                                                                                  |\n"
					"|                                                                                                  |\n"
					"|                                                                                                  |\n" 
					"|                                                                                                  |\n"
		...
		strcpy(box, new);
		 ...
		 char *new = "----------------------------------------------------------------------------------------------------\n"
					"|                                                                                                  |\n"
					"|                                                                                                  |\n"
					"|     A hoard of zombies is approaching!! Prepare yourself! Time your attacks well!                |\n"
					"|                                                                                                  |\n"
					"|                                                                                                  |\n"
					"|                                                                                                  |\n" 
					"|                                                                                                  |\n"
...
void noDoorChoiceHandler(LowerBox *lower) {
	...
	char *box = 	"----------------------------------------------------------------------------------------------------\n"
					"|                                                                                                  |\n"
					"|                                                                                                  |\n"
					"|     Oh no, the elevator broke down! Prepare yourselves before the door opens!                    |\n"
					"|                                                                                                  |\n"
					"|                                                                                                  |\n"
					"|                                                                                                  |\n" 
					"|                                                                                                  |\n"
